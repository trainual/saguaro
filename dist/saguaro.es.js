...
function ir() {
  if (Re)
    return A;
  Re = 1;
  var x = Oe, E = Symbol.for("react.element"), j = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, T = x.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, O = { key: !0, ref: !0, __self: !0, __source: !0 };
  function k(h, l, C) {
    var v, b = {}, _ = null, $ = null;
    C !== void 0 && (_ = "" + C), l.key !== void 0 && (_ = "" + l.key), l.ref !== void 0 && ($ = l.ref);
    for (v in l)
      m.call(l, v) && !O.hasOwnProperty(v) && (b[v] = l[v]);
    if (h && h.defaultProps)
      for (v in l = h.defaultProps, l)
        b[v] === void 0 && (b[v] = l[v]);
    return { $$typeof: E, type: h, key: _, ref: $, props: b, _owner: T.current };
  }
...
function ur() {
  return Te || (Te = 1, process.env.NODE_ENV !== "production" && function() {
    var x = Oe, E = Symbol.for("react.element"), j = Symbol.for("react.portal"), m = Symbol.for("react.fragment"), T = Symbol.for("react.strict_mode"), O = Symbol.for("react.profiler"), k = Symbol.for("react.provider"), h = Symbol.for("react.context"), l = Symbol.for("react.forward_ref"), C = Symbol.for("react.suspense"), v = Symbol.for("react.suspense_list"), b = Symbol.for("react.memo"), _ = Symbol.for("react.lazy"), $ = Symbol.for("react.offscreen"), X = Symbol.iterator, Ce = "@@iterator";
    function Se(e) {
    ...
    function Fe(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === m || e === O || De || e === T || e === C || e === v || ke || e === $ || we || xe || je || typeof e == "object" && e !== null && (e.$$typeof === _ || e.$$typeof === b || e.$$typeof === k || e.$$typeof === h || e.$$typeof === l || // This needs to include all possible module reference object
    ...
    var R = Object.assign, D = 0, ee, re, te, ne, ae, oe, ie;
    function ue() {
    }
...
const lr = ({
  ...
  const O = x ? "storybook-button--primary" : "storybook-button--secondary";
  return /* @__PURE__ */ sr.jsx(
    "button",
    {
      type: "button",
      className: ["storybook-button", `storybook-button--${E}`, O].join(" "),
